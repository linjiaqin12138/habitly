...
export default function CheckinEditPage() {
  ...
  const [checkinProfile, setCheckinProfile] = useState<CheckinProfileForm | undefined>(undefined);
                    ...
                    <div className="flex justify-end space-x-4">
                      ...
                      <AlertDialog>
                        <AlertDialogTrigger asChild>
                          <Button variant="destructive" disabled={saveLoading}>
                        ...
                        <AlertDialogContent>
                          ...
                          <AlertDialogFooter>
                            ...
                            <AlertDialogAction
                              onClick={handleDeleteCheckinProfile}
